...
public class Day22Tests {
  ...
  public void TestPart1() {
    var assertions = new[] {
      ("Tests/Inputs/22_1.txt", 39),
      ("Tests/Inputs/22_2.txt", 590784),
      ("Tests/Inputs/22_3.txt", 474140)
    };
  ...
  public void TestPart2() {
    var assertions = new[] {
      ("Tests/Inputs/22_1.txt", 39),
      ("Tests/Inputs/22_2.txt", 39769202357779),
      ("Tests/Inputs/22_3.txt", 2758514936282235)
    };
